...
const exerciseSchema = mongoose.Schema({
	...
	reps: { type: Number, required: true, min: 1, validate: (reps) => Number.isInteger(reps)},
	weight: { type: Number, required: true, min: 1, validate: (weight) => Number.isInteger(weight)},
